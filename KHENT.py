...
def create_biography():
    ...
    birth_date = st.date_input("Date of Birth", value=datetime.date(2005, 11, 6))
    ...
    # Display default image (this is an image URL, so it is displayed directly using st.image)
    st.header("Profile Picture")
    st.image("https://scontent.fcgy2-4.fna.fbcdn.net/v/t39.30808-6/462617095_885906273639494_5384351385961036595_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeEo4FhRajkDbb-17-1R_GZzlP8O3xJa6vSU_w7fElrq9ApvZtlOoGOR2n4t96ZIR8pB8NY3N3z39843ACNxvKCm&_nc_ohc=OnUwvwWI32QQ7kNvgF0JCLL&_nc_zt=23&_nc_ht=scontent.fcgy2-4.fna&_nc_gid=AaEP6EsvCx5DiJdmLGphIPw&oh=00_AYDhTYZjMNVCpply3hat1pqS_1c7b3nzmPXsKz1oqHsElQ&oe=674B6FCD", caption="Profile Picture")
